<main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">News Letters</h1>
              </div>
              <div class="col-sm-6">
                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">News Letters Cadastradas</h3>
                      </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                          <div class="input-group input-group-sm w-auto">
                            ...
                            <input
                              ...
                              id="user-search"
                              class="form-control"
                              placeholder="Pesquisar News Letter"
                              aria-label="Pesquisar News Letter"
                              style="width: 180px"
                            />
                          </div>
                          <select
                      ...
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              @if($lista->email_news)
                                 <span class="badge text-bg-sucess"> {{$lista->email_news}}</span>
                          ...
                          @empty
                            <tr>
                              ...
                              >
                              Nenhuma News Letter cadastrada.  
                              </td>
                            </tr>
                          @endforelse
                        </tbody>
