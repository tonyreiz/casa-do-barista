                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          @forelse ($listaProduto as $lista)

                          @php
                            $categoria = $lista->ProdutoCategoria;    
                          @endphp
                          <tr>
                            {{-- ID --}}
                            <td>
                            ...
                            <td>
                              ...
                              @if($lista->nome_produto)
                                 <span class="badge text-bg-sucess"> {{$lista->nome_produto}}</span>
                            ...
                            {{-- CATEGORIA --}}
                            <td>
                                <span class="badge text-bg-sucess"> {{$categoria->nome_categoria}}</span>                                  
                            </td>

                            {{-- DESCRIÇÃO PRODUTO --}}

                            <td>
                                <span class="badge text-bg-sucess"> {{$lista->descricao_longa_produto}}</span>
                            </td>
                            
                            {{-- VALOR PRODUTO --}}
                            
                            <td>
                                <span class="badge text-bg-sucess"> R$ {{$lista->valor_produto}}</span>
                            </td>
                            
                            {{-- IMAGEM PRODUTO --}}

                            <td>
                                <img src="{{ asset('barista/assets/' . $lista->imagem_produto)}}" alt="{{$lista->nome_produto}}"
                                class="rounded"
                                style="
                                   height: 75px;         
                                    width: 100px;
                            ...
                            <td>
                                @if ($lista->destaque_produto === 1)
                                    <span class="badge text-bg-sucess"> Destacado</span>    
                                @else
                                    <span class="badge text-bg-sucess"> Não possui produto em destaque</span>
                                    
                                @endif
                            </td>

                            <td>
                              @if($lista->status_produto === 'ATIVO')
