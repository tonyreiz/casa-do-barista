                        ...
                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                          <div class="input-group input-group-sm w-auto">
                            ...
                            <input
                              ...
                              aria-label="Pesquisar Depoimento"
                              style="width: 180px"
                            />
                          </div>
                          <select
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          @forelse ($listaDepoimento as $lista)
                          <tr>
                            {{-- ID --}}
                            <td>
                              {{$lista->id_depoimento}}
                            ...
                            {{-- TÍTULO --}}
                            <td>
                              @if($lista->titulo_depoimento)
                                 <span class="badge text-bg-sucess"> {{$lista->titulo_depoimento}}</span>
                            ...
                            <td>
                                <span class="badge text-bg-sucess"> {{$lista->descricao_depoimento}}</span>
                            </td>


                            <td>
                              @if($lista->status_depoimento === 'ATIVO')
