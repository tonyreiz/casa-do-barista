<head>
    ...
    <!-- DESCRIÇÃO DO SITE -CEO E COMPARTILHAMENTO -->
...
Cada xícara é uma narrativa do produtor ao barista, do barista ao cliente. Aqui, o tempo desacelera, os sentidos despertam e o café volta a ser o que sempre foi: um ritual de cuidado e partilha.">
    ...
    <!-- PALAVRA CHAVE -->
    <meta name="keywords" content="café,artesanal,xícara, café brasileiro,grão,barista">



    <!--   AUTOR do SITE -->
    <meta name="author" content="Anthony Reis">


    <!-- OPEN GRAPH(compartilhar nas redes sociais) -->
    <meta property="og:title" content="Casa do Barista">

    <meta prioperty="og:description"
        content="Mais do que servir café, é um ambiente que celebra o ofício artesanal, a cultura do café brasileiro e as histórias por trás de cada grão.
 Cada xícara é uma narrativa do produtor ao barista, do barista ao cliente. Aqui, o tempo desacelera, os sentidos despertam e o café volta a ser o que sempre foi: um ritual de cuidado e partilha">
    ...
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('barista/assets/icon/android-icon-72x72.png') }}">
    ...
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('barista/assets/icon/android-icon-144x144.png') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('barista/css/slick.css') }}">
    <link rel="stylesheet" type="text/css" href="{{asset('barista/css/slick-theme.css') }}">
      <link
    rel="stylesheet"
